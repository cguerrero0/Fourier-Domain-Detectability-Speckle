Algorithm: Construction of a detectability map in the (q, Delta m) plane

Input:
    Grid of normalized separations q
    Grid of magnitude differences Delta m
    Effective attenuation factor eta_eff
...
For each value of Delta m:
    ...
    For each value of q:
        ...
        Repeat N times:
            ...
            Apply the attenuation model through eta_eff
